# UX Walkthrough Review - 2026-07-10T04-15-01
...
- Started: 2026-07-10T10:15:20.356Z
- Finished: 2026-07-10T10:17:17.466Z
- Journeys: 3 (0 failed)
...
- Viewport: 1280x720
- Started: 2026-07-10T10:15:20.356Z
- Finished: 2026-07-10T10:16:27.652Z
...
- [ok] 7. submit campaign wizard and land on dashboard (default)
  - Route: /gameplay/campaigns/campaign-1783678541278-d1fvlpi
...
- [ok] 9. open contract market (default)
  - Route: /gameplay/campaigns/campaign-1783678541278-d1fvlpi/contract-market
...
- [ok] 11. open campaign missions (default)
  - Route: /gameplay/campaigns/campaign-1783678541278-d1fvlpi/missions
...
- [ok] 12. open mission launch briefing (default)
  - Route: /gameplay/campaigns/campaign-1783678541278-d1fvlpi/missions/contract-1783678545352-02pb7vg/launch
...
- [ok] 13. select roster and launch mission to pre-battle (default)
  - Route: /gameplay/encounters/encounter-dff6dc47-2e4a-4dd8-87ad-63ce329f1ad5/pre-battle?campaignId=campaign-1783678541278-d1fvlpi&missionId=contract-1783678545352-02pb7vg
...
- [ok] 14. attempt manual tactical play from pre-battle (default)
  - Route: /gameplay/games/72f70a5e-97a2-40d0-a171-89865c77c2de?campaignId=campaign-1783678541278-d1fvlpi&missionId=contract-1783678545352-02pb7vg
...
- [ok] 15. return to pre-battle and auto-resolve mission (default)
  - Route: /gameplay/games/103a1944-60a4-4eea-bd03-f935c848076e?campaignId=campaign-1783678541278-d1fvlpi&missionId=contract-1783678545352-02pb7vg
...
- [ok] 24. check campaign ledger (default)
  - Route: /gameplay/campaigns/campaign-1783678541278-d1fvlpi/log
...
- Viewport: 1280x720
- Started: 2026-07-10T10:16:28.031Z
- Finished: 2026-07-10T10:16:41.404Z
...
- [ok] 2. host creates and guest joins co-op campaign (default)
  - Route: /gameplay/campaigns/campaign-1783678590725-cqrgo9w
...
- [ok] 3. guest direct route shows read-only co-op ledger (guest)
  - Route: /gameplay/campaigns/campaign-1783678590725-cqrgo9w/gm-ledger
...
- [ok] 4. host creates 1v1 match and guest joins lobby (default)
  - Route: /multiplayer/lobby/U7UDS2
  - Screenshot: 09-coop-multiplayer-two-client/04-host-creates-1v1-match-and-guest-joins-lobby.png
  - Duration: 5019 ms

#### Findings

- C3-HARNESS-DIVERGENCE (minor): Harness uses MULTIPLAYER_STORE=durable for Playwright; it does not reproduce the plain-dev in-memory split-store C3 path. Co-op badge reads wait for hydration before capture. Host campaign=campaign-1783678590725-cqrgo9w, guest campaign=campaign-1783678590725-cqrgo9w, host badge=Co-op session: HostSX64HX, guest badge=Co-op session: Guest, join error=none.
...
- COOP-GUEST-LEDGER-READONLY (minor): Guest direct gm-ledger route read-only=true; notice=true, playerView=true, playerLog=true, hiddenAbsent=true, controlsAbsent=true, privateLogAbsent=true, navLinkAbsent=true, gmSurfaceAfterReload=false, survivedReload=true.
  ...
  - Reviewer verdict: \_\_\_ (confirmed / not reproducible / fixed)
  - Reviewer notes: \_\_\_
- MULTIPLAYER-LOBBY-OCCUPIED (minor): 1v1 lobby occupied=true; host alpha="Alpha #1Deep Play HostNot readyLeaveReadySet AI", host bravo="Bravo #1pid_4G9P8LTJuma3rQ4Uc9meWHDVD6x3Not readySet AI", guest alpha="Alpha #1Deep Play HostNot ready", guest bravo="Bravo #1pid_4G9P8LTJuma3rQ4Uc9meWHDVD6x3Not readyLeaveReady".
...
- Viewport: 1280x720
- Started: 2026-07-10T10:16:41.463Z
- Finished: 2026-07-10T10:17:17.119Z
...
- [ok] 6. add four units and four assigned pilots (default)
  ...
  - Duration: 752 ms
- [ok] 7. submit campaign wizard and land on dashboard (default)
  - Route: /gameplay/campaigns/campaign-1783678610109-slqidec
  - Screenshot: 10-gm-surfaces/07-submit-campaign-wizard-and-land-on-dashboard.png
  - Duration: 834 ms
- [ok] 8. open campaign GM ledger (default)
  - Route: /gameplay/campaigns/campaign-1783678610109-slqidec/gm-ledger
...
- [ok] 14. open contract market (default)
  - Route: /gameplay/campaigns/campaign-1783678610109-slqidec/contract-market
...
- [ok] 16. open campaign missions (default)
  - Route: /gameplay/campaigns/campaign-1783678610109-slqidec/missions
  - Screenshot: 10-gm-surfaces/16-open-campaign-missions.png
  - Duration: 2190 ms
  - Console/page errors: 1
- [ok] 17. open mission launch briefing (default)
  - Route: /gameplay/campaigns/campaign-1783678610109-slqidec/missions/contract-1783678616326-oyvfnfh/launch
...
- [ok] 18. select roster and launch mission to pre-battle (default)
  - Route: /gameplay/encounters/encounter-2dc99650-1eef-4f71-a4d3-02481e6f9dbf/pre-battle?campaignId=campaign-1783678610109-slqidec&missionId=contract-1783678616326-oyvfnfh
...
- [ok] 19. open manual battle before switching to GM query mode (default)
  - Route: /gameplay/games/0c83346b-ea6a-4164-9fdb-1413af7d5835?campaignId=campaign-1783678610109-slqidec&missionId=contract-1783678616326-oyvfnfh
...
- [ok] 20. enter battle GM dock via query param (default)
  - Route: /gameplay/games/0c83346b-ea6a-4164-9fdb-1413af7d5835?campaignId=campaign-1783678610109-slqidec&missionId=contract-1783678616326-oyvfnfh&gm=1
...
- GM-TIME-CASCADE (moderate): Time cascade correction was captured with the full current preview panel; UI currently exposes a summary/effects list rather than per-day breakdown.
  ...
  - Reviewer verdict: \_\_\_ (confirmed / not reproducible / fixed)
  - Reviewer notes: \_\_\_
- C2-STATUS (minor): GM Advance Phase before="Initiative" after="Movement"; phaseChanged=true, composer=true, terminal=none, error=none.
