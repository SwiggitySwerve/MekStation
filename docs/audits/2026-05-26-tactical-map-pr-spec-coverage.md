...
- Hull-down: vehicle/QuadVee fortified-side-table behavior and punch/club
  hull-down hit-table nuances remain follow-up work.
  ...
  entry, and prone-to-hull-down actuator/hip costs are no longer open
