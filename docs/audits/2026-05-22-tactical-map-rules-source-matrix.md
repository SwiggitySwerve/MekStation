...
UI controls that mutate infantry mount or conversion state, and broader external
oracle differential fixtures. Replayable gameplay events for runtime movement
state are covered by `apply-runtime-movement-state-events`.
