...
- [x] 1.4 Create compact System Components panel with inline weight/slots
- [x] 1.5 Create Movement panel with Base/Final columns
- [x] 1.6 Add Walk MP input with +/- buttons
