...
Campaign instances represent units and pilots deployed within a specific campaign context, tracking their gameplay state (damage, XP, wounds) separately from vault design templates.
