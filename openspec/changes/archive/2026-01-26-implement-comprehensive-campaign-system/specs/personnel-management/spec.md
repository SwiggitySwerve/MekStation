...
The system SHALL track personnel skills and attributes with 7 core attributes (STR, BOD, REF, DEX, INT, WIL, CHA) plus Edge.
...
- **THEN** the attribute modifier of +2 is applied
