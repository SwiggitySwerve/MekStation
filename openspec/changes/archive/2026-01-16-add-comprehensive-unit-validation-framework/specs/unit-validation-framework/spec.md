...
Defines a hierarchical validation framework for all MekStation unit types. Provides universal validation rules applicable to every unit, category-specific rules for related unit groups, and unit-type-specific rules for individual unit validation.
