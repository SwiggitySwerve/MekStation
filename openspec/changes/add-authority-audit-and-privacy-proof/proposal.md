...
- Require durable active-membership resolution before socket attachment, replay, journal/history reads, command handling, effect ingestion, or publication.
...
- `multiplayer-server`: Require active durable membership and server-derived authority scope before attachment, replay, command handling, effect ingestion, or publication.
