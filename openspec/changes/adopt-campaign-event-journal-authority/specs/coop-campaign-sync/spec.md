...
- **THEN** the host SHALL derive and atomically append the entire committed event batch at the expected revision
- **AND** only after commit SHALL it apply the committed batch and broadcast authorized projections
