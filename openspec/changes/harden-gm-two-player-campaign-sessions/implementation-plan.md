...
4. Completed sidecars: `refine-combat-turn-rail` and `persist-interactive-combat-events` are archived after their canonical specs were synchronized. These shipped outcomes remain supporting refinements rather than authority dependencies for the event-history path.
