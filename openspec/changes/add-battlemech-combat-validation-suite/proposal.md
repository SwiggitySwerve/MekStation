...
- Record the current headway: shared missing/destroyed/self/friendly/non-adjacent/evading-attacker/transported-passenger/swarming/target-making-DFA/airborne-target/building-occupancy gates, push attacker/target Mek unit-type gates, push quad BattleMech rejection, push rear-flipped-arm rejection, charge standing-Mek target gates, charge non-Mek-to-infantry/ProtoMech target gates, charge elevation-overlap gates, charge target movement-complete/immobile gates, push no-arms, both-arms-present, same-elevation, attacker-not-prone, target-not-prone, target-directly-ahead, push-destination-valid, push arm-fired gate with runner weapon-location hydration gap, DFA jump/prone/infantry-family-attacker/target-inside-building gates, and catalog contract coverage are now tracked.
