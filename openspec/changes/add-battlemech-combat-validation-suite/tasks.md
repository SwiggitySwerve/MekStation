...
- [x] 4.3.135 Promote `InitiativeOrderSet` event-stream support by emitting a replayable order event after initiative rolls, applying it in the reducer, and keeping simultaneous `AttacksRevealed` as the remaining unsupported planning event.
