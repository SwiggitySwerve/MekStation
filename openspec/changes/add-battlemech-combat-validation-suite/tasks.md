...
- [x] 3.2.5 Integrate source-backed standard MASC/Supercharger fixed failure target numbers through explicit prior-use state, apply MASC failed-check leg critical damage, and apply BattleMech Supercharger failed-check slot/engine critical damage while leaving alternate MASC option tables, IndustrialMek/support-unit supercharger adjustment, Edge rerolls, separate first-step equipment-check timing, and non-BattleMech Supercharger motive damage explicit.
