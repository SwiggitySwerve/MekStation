...
- [x] 3.4.37a Integrate source-backed sprinting-attacker ranged invalidation through runner weapon attack validation, event-sourced `declareAttack`, AttackInvalid reason cataloging, OpenSpec coverage, and no-side-effect behavior tests while leaving optional TacOps Sprint movement-step action, heat, authoritative state creation, and sprinting spotter restrictions explicit.
...
- [x] 4.3.124 Consume explicit target-sprinted state through helper, event-sourced, and runner ranged to-hit hydration while keeping optional TacOps Sprint movement-step creation, sprint heat, authoritative state creation, and sprinting spotter restrictions visible as absent-action gaps.
- [x] 4.3.125 Consume explicit sprinting-attacker state through event-sourced and runner ranged attack invalidation while keeping optional TacOps Sprint movement-step creation, sprint heat, authoritative state creation, and sprinting spotter restrictions visible as absent-action gaps.
