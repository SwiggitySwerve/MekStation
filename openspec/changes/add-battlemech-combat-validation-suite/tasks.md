...
- [x] 4.3.124 Consume explicit target-sprinted state through helper, event-sourced, and runner ranged to-hit hydration while keeping optional TacOps Sprint movement-step creation, sprint heat, and authoritative state creation visible as absent-action gaps.
- [x] 4.3.125 Consume explicit sprinting-attacker state through event-sourced and runner ranged attack invalidation while keeping optional TacOps Sprint movement-step creation, sprint heat, and authoritative state creation visible as absent-action gaps.
