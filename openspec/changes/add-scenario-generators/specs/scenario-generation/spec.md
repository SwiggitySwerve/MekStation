...
Scenario generation provides automated creation of battle setups including enemy forces, objectives, terrain, and modifiers for both quick games and campaign missions.
