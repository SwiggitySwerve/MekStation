...
9. **CAMP-01H — journey/audit (≤5/300):** handoff, long-browser, viewport commands; receipt `camp01h-journey-<sha>/authority-receipt.json`; `assertions=[routeSequenceMatched,apiIdentityMatched,storeIdentityMatched,persistenceIdentityMatched,reloadIdentityMatched,desktopInspected,mobileInspected,commandBrowserObservedCount,commandBrowserFailureCount,developmentMimeRegressionCovered,guestBadgeRegressionCovered,saveConflictRegressionCovered,proof02RepairsVerified]`; `artifacts=[wave-result.json,playwright-report.json,desktop.png,mobile-390x844.png,audit-reconciliation.json]`.
