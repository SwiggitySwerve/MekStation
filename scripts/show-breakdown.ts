...
const patterns = [
  ...
  {
    name: 'ballistic-reinforced',
    test: (s: string) =>
      s.includes('ballistic-reinforced') || s.includes('ballistic reinforced'),
  },
  {
    name: 'reactive',
    test: (s: string) => s.includes('reactive') && !s.includes('ferro'),
  },
  {
    name: 'reflective',
    test: (s: string) =>
  ...
  },
  {
    name: 'hardened',
    test: (s: string) =>
      s.includes('hardened armor') || s.includes('is hardened'),
  },
  {
    name: 'anti-penetrative',
    test: (s: string) =>
      s.includes('anti-penetrative') || s.includes('ablation'),
  },
  {
    name: 'heat-dissipating',
    test: (s: string) => s.includes('heat-dissipating'),
  },
];
