...
console.log(
  'Has "droneoperatingsystem":',
  critsLo.some((s) => s.includes('droneoperatingsystem')),
);
console.log(
  'Has "drone operating system":',
  critsLo.some((s) => s.includes('drone operating system')),
);
console.log(
  'Has "small cockpit" in crits:',
  critsLo.some((s) => s.includes('small cockpit')),
);
console.log(
  'Cockpit field contains SMALL:',
  (unit.cockpit || '').toUpperCase().includes('SMALL'),
);
...
const cockpitCount = headSlots.filter(
  (s) => s && s.toLowerCase().includes('cockpit'),
).length;
