...
for (const id of targets) {
  ...
  console.log(
    `Offense: wBV=${b.rawWeaponBV} halved=${b.halvedWeaponBV} aBV=${b.ammoBV} wt=${b.weightBonus} phys=${b.physicalWeaponBV} offEq=${b.offEquipBV} sf=${b.speedFactor} heatEff=${b.heatEfficiency} heatDiss=${b.heatDissipation} moveHeat=${b.moveHeat}`,
  );
  console.log(
    `Defense: armor=${b.armorBV} struct=${b.structureBV} gyro=${b.gyroBV} defEq=${b.defEquipBV} expl=${b.explosivePenalty} df=${b.defensiveFactor} cockpit=${b.cockpitType}`,
  );
