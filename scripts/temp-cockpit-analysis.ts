...
console.log(
  `Standard cockpit units with "small" layout (sensors@3, no LS@5): ${standardWithSmallLayout}`,
);
console.log(
  `Standard cockpit units with standard layout: ${standardWithStandardLayout}`,
);
...
console.log(
  `Standard cockpit with 3 cockpit-related slots: ${smallCockpit3Slots}`,
);
console.log(
  `Standard cockpit with 5+ cockpit-related slots: ${standardCockpit5Slots}`,
);
