...
const MANIFEST_PATH = path.join(process.cwd(), 'public/record-sheets/mm-data-version.json');
...
function main() {
  ...
  if (fs.existsSync(MANIFEST_PATH)) {
    try {
      ...
      log(`✓ mm-data assets present (${manifest.version}, ${manifest.assetCount} files)`);
      return 0;
    } catch (e) {
