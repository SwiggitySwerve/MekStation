...
const hc = [
  ...
  ['mml-9-lrm-ammo', 11],
  ['mml-9-srm-ammo', 11],
  ['plasma-rifle-ammo', 26],
  ['isplasmarifleammo', 26],
  ['clan-plasma-cannon-ammo', 21],
  ['clplasmacannonammo', 21],
  ['streak-srm-ammo', 17],
  ['clan-streak-srm-2-ammo', 5],
  ['clan-streak-srm-4-ammo', 10],
  ['clan-streak-srm-6-ammo', 15],
  ['streak-srm-2-ammo', 4],
  ['streak-srm-4-ammo', 7],
  ['streak-srm-6-ammo', 11],
  ['is-streak-srm-2-ammo', 4],
  ['is-streak-srm-4-ammo', 7],
  ['is-streak-srm-6-ammo', 11],
  ['clan-ammo-lrm-5', 7],
  ['clan-ammo-lrm-10', 14],
  ['clan-ammo-lrm-15', 21],
  ['clan-ammo-lrm-20', 27],
  ...
  ['clan-rac-5-ammo', 43],
  ['clan-rac-20-ammo', 59],
  ['clanimprovedlrm5ammo', 7],
  ['clanimprovedlrm10ammo', 14],
  ['clanimprovedlrm15ammo', 21],
  ['clanimprovedlrm20ammo', 27],
];
...
for (const [id, hcBV] of hc) {
  ...
  if (catBV !== undefined && catBV !== hcBV) {
    conflicts++;
    console.log(
      `  ${id}: catalog=${catBV}, hardcoded=${hcBV}, diff=${hcBV - catBV}`,
    );
  }
}
