...
async function rmWithRetry(targetPath, { retries = 8, baseDelayMs = 150 } = {}) {
...
exports.default = async function afterPack(context) {
  ...
  const desktopDir =
    context && context.packager && typeof context.packager.projectDir === 'string'
  ...
  console.log(`[afterPack] Ensuring Next standalone public assets are packaged`);
