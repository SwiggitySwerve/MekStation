...
export const OPTION_META: Record<string, ICampaignOptionMeta> = {
  ...
  // =========================================================================
  scenarioXP: {
    key: 'scenarioXP', group: OptionGroupId.XpProgression,
  ...
  vocationalXP: {
    key: 'vocationalXP', group: OptionGroupId.XpProgression,
  ...
  vocationalXPTargetNumber: {
    key: 'vocationalXPTargetNumber', group: OptionGroupId.XpProgression,
  ...
  vocationalXPCheckFrequency: {
    key: 'vocationalXPCheckFrequency', group: OptionGroupId.XpProgression,
  ...
  adminXP: {
    key: 'adminXP', group: OptionGroupId.XpProgression,
  ...
  adminXPPeriod: {
    key: 'adminXPPeriod', group: OptionGroupId.XpProgression,
  ...
  missionFailXP: {
    key: 'missionFailXP', group: OptionGroupId.XpProgression,
  ...
  missionSuccessXP: {
    key: 'missionSuccessXP', group: OptionGroupId.XpProgression,
  ...
  missionOutstandingXP: {
    key: 'missionOutstandingXP', group: OptionGroupId.XpProgression,
  ...
  useAgingEffects: {
    key: 'useAgingEffects', group: OptionGroupId.XpProgression,
  ...
  // =========================================================================
  maxUnitsPerLance: {
    key: 'maxUnitsPerLance', group: OptionGroupId.ForceOrganization,
  ...
  maxLancesPerCompany: {
    key: 'maxLancesPerCompany', group: OptionGroupId.ForceOrganization,
  ...
  enforceFormationRules: {
    key: 'enforceFormationRules', group: OptionGroupId.ForceOrganization,
  ...
  allowMixedFormations: {
    key: 'allowMixedFormations', group: OptionGroupId.ForceOrganization,
  ...
  requireForceCommanders: {
    key: 'requireForceCommanders', group: OptionGroupId.ForceOrganization,
  ...
  useCombatTeams: {
    key: 'useCombatTeams', group: OptionGroupId.ForceOrganization,
  ...
  trackFactionStanding: {
    key: 'trackFactionStanding', group: OptionGroupId.FactionStanding,
  ...
  regardChangeMultiplier: {
    key: 'regardChangeMultiplier', group: OptionGroupId.FactionStanding,
