 ...
 * }
 */
export interface IWeightedComponent<TType extends string = string> extends IComponentConfig<TType> {
 ...
 * }
 */
export interface ISlottedComponent<TType extends string = string> extends IComponentConfig<TType> {
