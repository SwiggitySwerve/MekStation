...
export const BATTLEMECH_ABSENT_ACTION_SUPPORT = {
  'movement.evade': unsupported(
    'movement.evade',
    'absent-action-surface',
    'Evade is a source-backed optional TacOps movement surface with running movement, evasion heat, attacker firing restrictions, and target to-hit modifiers; explicit evading attacker state now blocks ranged and physical attacks, but tactical commands, MovementType, game intents, wire payloads, P2P translation, runner movement phases, authoritative evasion state creation, and target-evasion modifier paths have no authoritative evade action path',
