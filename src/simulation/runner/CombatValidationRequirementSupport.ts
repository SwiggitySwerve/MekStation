...
export const BATTLEMECH_VALIDATION_REQUIREMENT_SUPPORT = {
  ...
  'movement-actions': helperOnly(
    'movement-actions',
    'Action and movement rule maps cover walk, run, jump, same-hex facing rotation, stand/careful-stand, hull-down, source-backed voluntary go-prone including non-Mek/already-prone/stuck legality and hull-down zero-MP posture transition, source-backed sprint/evade/MASC/Supercharger lower-stack support as absent player action surfaces, prone state, source-backed torso-twist exposure with replayed secondaryFacing consumption, and local shell-row exclusions',
    'Current player tactical command registry does not expose Sprint, Evade, MASC activation, or Supercharger activation directly; engine-variant/coolant sprint heat, go-prone swarmer dislodge, and inferno wash-off side paths remain helper-only; torso-twist lower-level UI direction/reset refinements remain outside the authoritative action path',
    [
