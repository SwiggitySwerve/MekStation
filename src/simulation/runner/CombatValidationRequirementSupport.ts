...
export const BATTLEMECH_VALIDATION_REQUIREMENT_SUPPORT = {
  ...
  'physical-self-risk': helperOnly(
    'physical-self-risk',
    'Runner and event-sourced physical behavior cover charge/DFA target damage, self-damage, successful push/charge/DFA displacement, occupied-hex domino positional displacement cascades with DominoEffect PSRs, DFA-miss friendly occupied displacement avoidance, helper-level grounded DropShip radius-two displacement search, same-phase runner occupancy refresh after displacement, blocked successful-charge displacement no-op/no-PSR semantics, charge/DFA miss displacement, source-backed immediate DFA miss fall damage/prone timing and pilot-damage avoidance, DFA impossible-displacement destruction, source-backed successful-DFA attacker PSR +4, miss consequences, and PSR queueing',
    'Legacy/local ChargeMiss and DFAMiss PSR factories plus domino step-out and broader displacement terrain/building/environment fallout and runtime grounded DropShip footprint/source occupancy hydration remain visible helper or unsupported boundaries',
    [
