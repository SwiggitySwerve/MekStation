...
export const BATTLEMECH_VALIDATION_REQUIREMENT_SUPPORT = {
  ...
  'pilot-skills': helperOnly(
    'pilot-skills',
    'Pilot skill support covers gunnery, piloting, indirect-fire spotter gunnery, wound penalties, PSR resolution, source-backed Command Mech/Battle Computer force initiative bonuses, and explicit HQ/command equipment initiative bonuses',
    'Tactical Genius reroll requests, Combat Intuition first-round sequencing, and automatic command-console/HQ initiative equipment hydration are still helper-only',
