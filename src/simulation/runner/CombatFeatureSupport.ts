...
export const SPECIAL_WEAPON_FAMILY_COMBAT_SUPPORT = {
  ...
  narc: helperOnly(
    ...
    'Remaining iNarc ECM sensor effects, ambiguous/player-authored C3 network assignment, and C3 equipment damage lifecycle are not wired into runner combat resolution',
  ),
  ams: helperOnly(
    'ams',
