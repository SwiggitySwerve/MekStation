import {
  megamekSourceRef as legacyPilotMegamekRef,
  mekstationDeviationSourceRef as legacyPilotMekStationRef,
  type ICombatFeatureSourceReference,
} from './CombatFeatureSourceReference';
import { MEGAMEK_CALLED_SHOT_SOURCE_REFS } from './CombatPilotModifierSourceRefs';

const MEGAMEK_GUNNERY_OPTION_REGISTRY_SOURCE_REF = legacyPilotMegamekRef(
...
const MEGAMEK_GUNNERY_OPTION_ID_SOURCE_REF = legacyPilotMegamekRef(
...
const MEKSTATION_ATTACKER_SPA_AGGREGATION_SOURCE_REF = legacyPilotMekStationRef(
  ...
  'src/utils/gameplay/spaModifiers/integration.ts#L66-L120',
);

export const MEGAMEK_WEAPON_SPECIALIST_SOURCE_REFS = [
  legacyPilotMegamekRef(
