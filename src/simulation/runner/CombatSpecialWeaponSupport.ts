...
export const SPECIAL_WEAPON_MECHANIC_COMBAT_SUPPORT = {
  ...
  'inarc-pod-variants': helperOnly(
    ...
    'Remaining iNarc ECM sensor effects, ambiguous/player-authored C3 network assignment, and C3 equipment damage lifecycle are not represented in runner combat resolution',
    MEGAMEK_INARC_POD_TYPE_SOURCE_REFS,
  ),
