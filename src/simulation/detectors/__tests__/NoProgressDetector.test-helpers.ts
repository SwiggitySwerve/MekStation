/**
 * NoProgressDetector Test Helpers
 *
...
export interface NoProgressDetectorTestContext {
  readonly getDetector: () => NoProgressDetector;
}

export { NoProgressDetector, GameEventType, GamePhase, GameSide };
