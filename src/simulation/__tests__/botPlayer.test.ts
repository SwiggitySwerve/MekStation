...
import { Facing, MovementType, GamePhase, GameEventType } from '@/types/gameplay';
import type { IHexCoordinate, IMovementCapability, IHex, IHexGrid } from '@/types/gameplay';
...
describe('BotPlayer', () => {
  ...
  describe('edge cases', () => {
    ...
    it('should not attack destroyed targets', () => {
      ...
      const targets = [
        createMockUnit({ unitId: 'target', position: { q: 5, r: 0 }, destroyed: true }),
      ];
