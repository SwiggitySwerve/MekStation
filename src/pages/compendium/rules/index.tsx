    ...
    items: [
      {
        ...
        content:
          'The default internal structure type. Weight equals 10% of total tonnage.',
        formula: 'Weight = Tonnage × 0.10',
      },
      {
        title: 'Endo Steel',
        content:
          'Lighter structure using advanced materials. Weight equals 5% of total tonnage. Requires 14 critical slots (IS) or 7 slots (Clan).',
        formula: 'Weight = Tonnage × 0.05',
      },
      {
        title: 'Composite Structure',
        content:
          'Lighter but fragile structure. Weight equals 5% of total tonnage. Takes double internal damage from crits.',
        formula: 'Weight = Tonnage × 0.05',
      },
      {
        title: 'Reinforced Structure',
        content:
          'Heavier but more durable. Weight equals 20% of total tonnage. Takes half internal damage.',
    ...
    items: [
      {
        title: 'Engine Rating',
        content:
          'Determines movement capability. Walking MP × Tonnage = Engine Rating.',
        formula: 'Rating = Walk MP × Tonnage',
      },
      {
        title: 'Fusion Engine (Standard)',
        content:
          'The baseline engine. Uses the standard weight table and occupies 6 critical slots in center torso.',
      },
      {
        title: 'XL Engine',
        content:
          'Half the weight of standard. Also occupies 3 slots in each side torso. Destruction of side torso destroys mech.',
      },
      {
        title: 'Light Engine',
        content:
          '75% the weight of standard. Occupies 2 slots in each side torso. More survivable than XL.',
      },
      {
        title: 'Compact Engine',
        content:
          '150% the weight of standard but only uses 3 center torso slots instead of 6.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        content:
          'Maximum armor points per location equals 2× the internal structure points. Head maximum is always 9.',
      ...
      },
      {
        ...
        content:
          'IS: 17.92 points/ton (14 slots). Clan: 19.2 points/ton (7 slots).',
      },
      {
        title: 'Light Ferro-Fibrous',
        content:
          '16.96 points per ton. Requires 7 critical slots. Inner Sphere only.',
      },
      {
        title: 'Heavy Ferro-Fibrous',
        content:
          '24.32 points per ton. Requires 21 critical slots. Inner Sphere only.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        content:
          'First (Engine Rating ÷ 25) heat sinks are included in the engine, no additional weight or slots.',
      ...
      },
      {
        ...
        content:
          'Dissipate 2 heat per turn. 1 ton each. IS: 3 slots, Clan: 2 slots (1 if engine integral).',
      },
    ],
  },
  {
    ...
    items: [
      {
        title: 'Standard Gyro',
        content:
          'Weight = ceiling(Engine Rating ÷ 100). Occupies 4 critical slots in center torso.',
        formula: 'Weight = ⌈Rating ÷ 100⌉',
      },
      {
        title: 'Compact Gyro',
        content:
          '150% the weight of standard but only occupies 2 critical slots.',
      },
      {
        title: 'Heavy-Duty Gyro',
        content:
          '200% the weight of standard. Survives 2 critical hits before destruction.',
      },
      {
        title: 'XL Gyro',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        content:
          'Light mechs: 0.5t each. Medium mechs: 1t each. Heavy mechs: 1t each. Assault mechs: 2t each.',
      },
      {
        title: 'Improved Jump Jets',
        content:
          'Double the weight of standard jump jets but can jump farther (2× max jump MP).',
      },
      {
        title: 'MASC',
        content:
          'Allows running at 2× walking speed for 1 turn. Weight = Rating ÷ 20 (IS) or Rating ÷ 25 (Clan).',
      },
    ],
  },
  {
    ...
    items: [
      {
        title: 'Head',
        content:
          '6 critical slots. Contains: Life Support, Sensors, Cockpit (2 slots each).',
      },
      {
        title: 'Center Torso',
        content:
          '12 critical slots. Contains: Engine (6 slots), Gyro (4 slots). 2 slots free.',
      },
      {
        title: 'Side Torsos',
        content:
          '12 critical slots each. Left and Right. May contain engine components for XL/Light engines.',
      },
      {
        title: 'Arms',
        content:
          '12 critical slots each. Contains: Shoulder, Upper Arm Actuator. Optional: Lower Arm, Hand.',
      },
      {
        title: 'Legs',
        content:
          '6 critical slots each. Contains: Hip, Upper Leg, Lower Leg, Foot actuators.',
      },
    ],
  },
];
...
const accentColorStyles: Record<
  AccentColor,
  { bg: string; text: string; border: string; navBg: string; navActive: string }
> = {
  amber: {
    bg: 'bg-amber-500/20',
    text: 'text-amber-400',
        ...
        {ruleSections.map((section) => {
          ...
          return (
            <section key={section.id} id={section.id} className="scroll-mt-24">
              ...
              {/* Rule Items */}
              <div className="bg-surface-base/30 border-border-theme-subtle overflow-hidden rounded-xl border">
                <div className="divide-border-theme-subtle/50 divide-y">
                  {section.items.map((item, index) => (
                    <article
                      key={index}
                      className="hover:bg-surface-base/30 px-6 py-5 transition-colors"
                    >
                      ...
                      {item.formula && (
                        <div className="bg-surface-raised/50 border-border-theme/50 mt-3 inline-block rounded-lg border px-3 py-1.5 font-mono text-sm text-cyan-400">
                          {item.formula}
                        </div>
                      )}
                    </article>
