...
describe('Component Responsive Behavior', () => {
  ...
  describe('KPICard', () => {
    const defaultProps: IKPICardProps = { label: 'Win Rate', value: '80%' };
...
describe('Visual Regression: Breakpoint Classes', () => {
  it('KPICard renders responsive grid parent (1 col mobile, 2 tablet, 4 desktop)', () => {
    render(
      ...
      >
        {' '}
        <KPICard label="A" value={1} /> <KPICard label="B" value={2} />{' '}
        <KPICard label="C" value={3} /> <KPICard label="D" value={4} />{' '}
      </div>,
    );
