...
describe('useMultiUnitStore', () => {
  ...
  describe('UNIT_TEMPLATES', () => {
    ...
    it('should have appropriate walk MPs for each weight class', () => {
      ...
      expect(lightTemplate?.walkMP).toBeGreaterThan(
        assaultTemplate?.walkMP ?? 0,
      );
    });
  });
  ...
  describe('createDefaultComponentSelections()', () => {
    ...
    it('should default to standard components', () => {
      ...
      expect(selections.internalStructureType).toBe(
  ...
  describe('duplicateTab()', () => {
    it('should duplicate tab with all configuration', () => {
      act(() => {
        ...
        useMultiUnitStore
          .getState()
          .updateTechBaseMode(tabId, TechBaseMode.MIXED);
    ...
    it('should create independent copy (not share references)', () => {
      ...
      expect(
        useMultiUnitStore.getState().tabs[0].componentSelections.gyroType,
      ).toBe(GyroType.STANDARD);
      expect(
        useMultiUnitStore.getState().tabs[1].componentSelections.gyroType,
      ).toBe(GyroType.XL);
    });
  ...
  describe('updateTechBaseMode()', () => {
    it('should update tech base mode', () => {
      ...
      act(() => {
        useMultiUnitStore
          .getState()
          .updateTechBaseMode(tabId, TechBaseMode.CLAN);
      });

      expect(useMultiUnitStore.getState().tabs[0].techBaseMode).toBe(
        TechBaseMode.CLAN,
      );
    });
    ...
    it('should reset componentTechBases when switching to IS', () => {
      ...
      act(() => {
        useMultiUnitStore
          .getState()
          .updateTechBaseMode(tabId, TechBaseMode.INNER_SPHERE);
      });
    ...
    it('should preserve componentTechBases when switching to mixed', () => {
      ...
      expect(
        useMultiUnitStore.getState().tabs[0].componentTechBases.engine,
      ).toBe(TechBase.CLAN);
      // Others should be IS
      expect(
        useMultiUnitStore.getState().tabs[0].componentTechBases.chassis,
  ...
  describe('Component Selection Updates', () => {
    describe('updateEngineType()', () => {
      it('should update engine type', () => {
        ...
        act(() => {
          useMultiUnitStore
            .getState()
            .updateEngineType(tabId, EngineType.XL_IS);
        });

        expect(
          useMultiUnitStore.getState().tabs[0].componentSelections.engineType,
        ).toBe(EngineType.XL_IS);
      });
      ...
      it('should mark tab as modified', () => {
        ...
        act(() => {
          ...
          useMultiUnitStore
            .getState()
            .updateEngineType(tabId, EngineType.LIGHT);
        });
    ...
    describe('updateEngineRating()', () => {
      it('should update engine rating', () => {
        ...
        expect(
          useMultiUnitStore.getState().tabs[0].componentSelections.engineRating,
        ).toBe(300);
      });
    });
    ...
    describe('updateStructureType()', () => {
      it('should update structure type', () => {
        ...
        act(() => {
          useMultiUnitStore
            .getState()
            .updateStructureType(tabId, InternalStructureType.ENDO_STEEL_IS);
        });

        expect(
          useMultiUnitStore.getState().tabs[0].componentSelections
    ...
    describe('updateCockpitType()', () => {
      it('should update cockpit type', () => {
        ...
        act(() => {
          useMultiUnitStore
            .getState()
            .updateCockpitType(tabId, CockpitType.SMALL);
        });

        expect(
          useMultiUnitStore.getState().tabs[0].componentSelections.cockpitType,
        ).toBe(CockpitType.SMALL);
      });
    });
    ...
    describe('updateHeatSinkType()', () => {
      it('should update heat sink type', () => {
        ...
        act(() => {
          useMultiUnitStore
            .getState()
            .updateHeatSinkType(tabId, HeatSinkType.DOUBLE_IS);
        });

        expect(
          useMultiUnitStore.getState().tabs[0].componentSelections.heatSinkType,
    ...
    describe('updateArmorType()', () => {
      it('should update armor type', () => {
        ...
        act(() => {
          useMultiUnitStore
            .getState()
            .updateArmorType(tabId, ArmorTypeEnum.FERRO_FIBROUS_IS);
        });

        expect(
          useMultiUnitStore.getState().tabs[0].componentSelections.armorType,
    ...
    describe('updateComponentSelections()', () => {
      it('should update multiple selections at once', () => {
        ...
        expect(componentSelections.internalStructureType).toBe(
          InternalStructureType.STANDARD,
        );
      });
    });
