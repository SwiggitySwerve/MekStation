 ...
 * Shows as a subtle banner at the top of the screen.
 */
...
export function OfflineIndicator({ className = '' }: OfflineIndicatorProps): React.ReactElement | null {
  ...
  return (
    <div
      className={`fixed top-0 left-0 right-0 bg-amber-600 text-white px-4 py-2 flex items-center justify-center gap-2 z-50 ${className}`}
      role="alert"
      aria-live="polite"
    >
