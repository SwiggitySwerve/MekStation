    ...
    <>
      ...
      <div className="bg-surface-deep flex h-screen flex-col overflow-hidden">
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          {/* Main content */}
          <main className="bg-surface-deep flex-1 scroll-pb-[calc(5rem+env(safe-area-inset-bottom,0px))] overflow-auto pb-[calc(5rem+env(safe-area-inset-bottom,0px))] md:scroll-pb-0 md:pb-0">
            {children}
          </main>
        </div>
