 ...
 */
export function getMegaMekStatusColor(
  current: number,
  maximum: number,
): string {
 ...
 */
export function getMegaMekFrontStatusColor(
  frontCurrent: number,
  totalMax: number,
): string {
 ...
 */
export function getMegaMekRearStatusColor(
  rearCurrent: number,
  totalMax: number,
): string {
 ...
 */
export function getTorsoFrontStatusColor(
  frontCurrent: number,
  totalMax: number,
): string {
 ...
 * @returns Status color
 */
export function getTorsoRearStatusColor(
  rearCurrent: number,
  totalMax: number,
): string {
 ...
 */
export function getArmorGradientId(
  current: number,
  maximum: number,
  isSelected: boolean,
): string {
  ...
  if (ratio >= ARMOR_STATUS.MODERATE.min)
    return 'url(#armor-gradient-moderate)';
 ...
 */
export function TankFillClipPath({
  id,
  fillPercent,
  x,
  y,
  width,
  height,
}: TankFillProps): React.ReactElement {
