  ...
  return (
    <div className={`relative inline-block ${className}`}>
      ...
      {showTooltip && hasMultipleBlockers && (
        <div
          className="absolute bottom-full left-1/2 z-50 mb-3 -translate-x-1/2 rounded-lg border border-slate-700 bg-slate-900 px-4 py-3 text-sm whitespace-nowrap text-slate-200 shadow-xl"
          role="tooltip"
        >
