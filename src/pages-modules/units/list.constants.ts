...
export function getUnitTypeDisplay(unitType: string): { label: string; badgeVariant: string; color: string } {
  return (
...
export function getWeightClassDisplay(weightClass: WeightClass): { label: string; color: string } {
  return (
